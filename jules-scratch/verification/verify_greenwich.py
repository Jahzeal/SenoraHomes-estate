...
def run():
    ...
    with sync_playwright() as p:
        ...
        page.goto(f'file://{os.getcwd()}/greenwich.html')

        # Take a screenshot before clicking the hamburger icon
        page.screenshot(path='jules-scratch/verification/greenwich_before_click.png')
        ...
        page.screenshot(path='jules-scratch/verification/greenwich_after_click.png')
